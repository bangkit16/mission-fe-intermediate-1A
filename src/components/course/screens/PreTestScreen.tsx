      ...
      >
        ...
        <div className="w-full mx-auto flex items-center justify-between gap-4 mt-10 pt-4 border-t border-gray-100 ">
          ...
          <button
            ...
            className="w-full flex justify-center items-center gap-2 px-6 py-3 border border-green-300  text-green-400 font-semibold rounded-xl hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
          ...
          <button
            ...
            className="w-full flex justify-center items-center gap-2 px-6 py-3 bg-green-500 text-white font-semibold rounded-xl hover:bg-green-600 transition-colors"
          >
            Selanjutnya
